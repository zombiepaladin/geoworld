...
EventController.prototype.resetLevels = function() {
	this.levels = {
	  ...
	  "level_5_4": new Level(this.game, level_5_4, entities_5_4),
	  "level_4_1": new Level(this.game, level_4_2, entities_4_2),
	  //"level_4_2": new Level(this.game, level_4_2, entities_4_2),// 4_1 is pointing to 4_2 until 4_1 is properly formatted.
	  "level_3_1": new Level(this.game, level_3_1, entities_3_1),
	  "level_3_2": new Level(this.game, level_3_2, entities_3_2),
	  "level_3_3": new Level(this.game, level_3_3, entities_3_3)
	};
}				  
...
LevelSelectScreen = function(levels) {
	...
	this.numLevels = {"Phase1": 0, "Phase2": 0, "Phase3": 3, "Phase4": 1, "Phase5": 3, 
